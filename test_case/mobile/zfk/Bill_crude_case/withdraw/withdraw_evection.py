...
import time
from pages.mobile_pages.Bill_crud_page.Bill_order_withdrawpage import Bill_my_order_page
...
class zfk_mobile_index_case(unittest.TestCase):
    ...
    def test_My_bills(self):
        #进入待提交
        self.Bill_my_order_page.In_approval_recall()
        #撤回出差申请单
        self.Bill_my_order_page.widthdraw_order_evection()
        self.Bill_my_order_page.log.info('-我的单据-审批中-内部-撤回借款申请单成功-')
        time.sleep(2)
    def tearDown(self):
        pass
