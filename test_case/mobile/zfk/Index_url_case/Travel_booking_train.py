...
class zfk_mobile_index_case(unittest.TestCase):
    ...
    def test_Login_mobile_addressTest(self):
        self.zfk_mobile_index_Page.log.info('[--首页-商旅预定-火车-跳转地址检测开始--]')
        self.Travel_booking_result = self.zfk_mobile_index_Page.Travel_booking_train()
        self.assertTrue(self.Travel_booking_result)
    def tearDown(self):
        time.sleep(5)
        pass
